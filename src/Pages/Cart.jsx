...
function Cart(){
    ...
    return(
        <div className="min-h-screen bg-gray-50 p-4 md:p-8 lg:p-12">
            {cartItems.length === 0 ? (
                <div className="mt-20 text-center flex justify-center items-center flex-col my-0 mx-auto py-20 bg-gray-400 rounded-xl w-1/2 shadow-2xl">
                    <p className="text-2xl text-black mb-4">Your cart is empty</p>
                    <Link to="/" className="inline-block px-6 py-4 bg-zinc-700 text-white font-bold rounded-lg">
                        Start Shopping
                    </Link>
                </div>
            ) : (
                <div className="flex flex-col lg:flex-row mt-20 gap-8">
                                    ...
                                    <div className="flex items-center justify-between w-full sm:w-3/5">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <button
                                                ...
                                                className="px-3 py-1 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors text-lg font-bold disabled::opacity-50"
                                        ...
                                        ><i className="fa-solid fa-trash-can text-xl"></i></button>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="lg:w-1/3 h-fit bg-white p-6 rounded-xl shadow-lg sticky top-28">
                        ...
                        className="w-1/2 mt-6 py-3 bg-gray-900 text-white font-semibold rounded-lg shadow-md hover:bg-gray-200 hover:text-gray-900 transition duration-300">
                            Checkout
                        </button>
                    </div>
                </div>
